...
import CartHeader from '../components.js/CartHeader';
...
const HomeTwo = () => {
    ...
    <div class="rts-caregory-area-two rts-section-gap">
            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="offer-area-main-wrapper">
                        ...
                        <p className="disc">
                            We have prepared special discounts for you on grocery products. <br></br>  Don't miss these opportunities...
                        </p>
