...
const ShopListTop=()=>{
    ...
    useEffect(() => {
        // Optional: You can perform side effects when the activeTab changes
        ...
        <div class="container">
            <div class="row g-0">
                <div class="col-xl-12 col-lg-12">
                    ...
                    <div className={`product-area-wrapper-shopgrid-list mt--20 tab-pane fade ${activeTab === 'home-tab' ? 'show active' : ''}` } id="home-tab-pane"  role="tabpanel" aria-labelledby="home-tab" tabindex="0">                                      <div class="row g-4">
                        ...
                        <div class="product-area-wrapper-shopgrid-list with-list mt--20 tab-pane fade  show active" >

                        <div  className={` ${activeTab === 'profile-tab' ? 'show active' : ''}`} id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">                            <div class="row">
                            <div class="row">
                                <div class="col-lg-6">
